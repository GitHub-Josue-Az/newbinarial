...
<body>
    ...
    <section class="fxt-template-animation fxt-template-layout29">
        <div class="container-fluid">
            <div class="row">
                <div class="vegas-container col-md-6 col-12 fxt-bg-img" id="vegas-slide" data-vegas-options='{"delay":10000, "timer":false,"animation":"kenburns", "transition":"swirlLeft", "slides":[{"src": "img/figure/bg29-l-1.jpg"}, {"src": "img/figure/bg29-l-2.jpg"}, {"src": "img/figure/bg29-l-3.jpg"}]}'>                  
                    <div class="fxt-page-switcher">
                        <a href="login-29.html" class="switcher-text1">Login</a>
                        <a href="register-29.html" class="switcher-text1">Register</a>
                    </div>
                </div>
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-3">
                                        <button type="submit" class="fxt-btn-fill">Enviar Correo</button>
                                    </div>
                                </div>
                            </form>                             
                        </div> 
