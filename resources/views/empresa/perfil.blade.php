...
<head>
    ...
    <meta name="description" content="Binarial admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, Frest admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="Binarial">
    <title>DASHBOARD EMPRESA</title>
    <link rel="apple-touch-icon" href="<?php echo url('/'); ?>/Backend/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo url('/'); ?>/Backend/images/ico/favicon.png">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo url('/'); ?>/Backend/css/pages/page-users.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-es"></i><span class="selected-language">Español</span></a>
                                <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="#" data-language="es"><i class="flag-icon flag-icon-es mr-50"></i> Español</a><a class="dropdown-item" href="#" data-language="en"><i class="flag-icon flag-icon-us mr-50"></i> English</a><a class="dropdown-item" href="#" data-language="fr"><i class="flag-icon flag-icon-fr mr-50"></i> French</a><a class="dropdown-item" href="#" data-language="de"><i class="flag-icon flag-icon-de mr-50"></i> German</a><a class="dropdown-item" href="#" data-language="pt"><i class="flag-icon flag-icon-pt mr-50"></i> Portuguese</a></div>
                            </li>
                        </ul>
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon bx bx-search"></i></a>
                            <div class="search-input">
                                ...
                                <input class="input" type="text" placeholder="Buscar Más..." tabindex="-1" data-search="template-search">
                                ...
                                <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="<?php echo url('/'); ?>/Backend/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="39" width="39"></div>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="<?php echo url('/'); ?>/Backend/images/portrait/small/avatar-s-16.jpg" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between cursor-pointer">
                                        <div class="media d-flex align-items-center py-0">
                                            <div class="media-left pr-0"><img class="mr-1" src="<?php echo url('/'); ?>/Backend/images/icon/sketch-mac-icon.png" alt="avatar" height="39" width="39"></div>
                                            <div class="media-body">
                                    ...
                                    <div class="d-flex justify-content-between read-notification cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img src="<?php echo url('/'); ?>/Backend/images/portrait/small/avatar-s-4.jpg" alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name">John Doe</span><span class="user-status text-muted">Available</span></div><span><img class="round" src="<?php echo url('/'); ?>/Backend/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span>
                            </a>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="home"></i><span class="menu-title" data-i18n="Projects">Proyectos
                    ...
                    <ul class="menu-content">
                        <li><a href=""><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Projets List">Mis Proyectos</span></a>
                        </li>
                        <li><a href=""><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice">Agregar Proyecto</span></a>
                        </li>
                ...
                <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="user"></i><span class="menu-title" data-i18n="Projects">Perfil</span></a>
                    <ul class="menu-content">
                        <li class="active"><a href=""><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Projets List">Ver Perfil</span></a>
                        </li>
                        <li><a href=""><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice">Editar Perfil</span></a>
                        </li>
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Ver Perfil</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Ver Perfil</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-7">
                            <div class="media mb-2">
                                <a class="mr-1" href="#">
                                    <img src="<?php echo url('/'); ?>/Backend/images/portrait/small/avatar-s-26.jpg" alt="users view avatar" class="users-avatar-shadow rounded-circle" height="64" width="64">
                                </a>
                                <div class="media-body pt-25">
                                    <h4 class="media-heading"><span class="users-view-name">Nombre Comercial </span></h4>
                                    <span>ID:</span>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <h5 class="mb-1"><i class="bx bx-info-circle"></i> Datos Personales</h5>
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                <td class="">RUC:</td>
                                                <td class="users-view-name pl-5">********</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="">Representación Legal:</td>
                                                <td class="users-view-name pl-5">********</td>
                                            </tr>
                                            <tr>
                                                <td class="">Celular1:</td>
                                                <td class="users-view-name pl-5">********</td>
                                            </tr>
                                            <tr>
                                                <td class="">Celular2:</td>
                                                <td class="users-view-name pl-5">********</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="">Email:</td>
                                                <td lass="users-view-name pl-5">********</td>
                                            </tr>
                                            <tr>
                                                <td class="">Cantidad de Empleados:</td>
                                                <td lass="users-view-name pl-5">********</td>
                                            </tr>
                                            <tr>
                                                <td class="">Estado:</td>
                                                <td><span class="badge badge-light-success users-view-status pl-5">Verificado</span></td>
                                            </tr>
                    ...
                    <div class="media m-75">
                        <a href="JavaScript:void(0);">
                            <div class="avatar mr-75">
                                <img src="<?php echo url('/'); ?>/Backend/images/portrait/small/avatar-s-2.jpg" alt="avtar images" width="32" height="32">
    ...
    <!-- BEGIN: Footer-->
    <footer class="footer footer-collapse footer-light">
        <p class="clearfix mb-0"><span class="float-left d-inline-block">2020 &copy; Derechos Reservados</span><span class="float-right d-sm-inline-block d-none">Desarrollado<i class="bx bxs-heart pink mx-50 font-small-3"></i>por<a class="text-uppercase" href="#" target="_blank">Binarial</a></span>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo url('/'); ?>/Backend/js/scripts/pages/page-users.js"></script>
    <!-- END: Page JS-->
